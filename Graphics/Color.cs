...
internal static class Color
{
    internal static readonly System.Drawing.Color White = System.Drawing.Color.White,
                                                  ...
                                                  PmColor = FromArgb(150, 180, 200),
                                                  ArcGray = FromArgb(60, 60, 60),
                                                  ArcPurple = FromArgb(31, 30, 51),
                                                  ArcRed = FromArgb(104, 9, 52),
                                                  GnaqGray = FromArgb(110, 110, 110),
                                                  AzusaGray = FromArgb(90, 90, 90);

    internal static System.Drawing.Color FromArgb(int alpha, System.Drawing.Color baseColor) => System.Drawing.Color.FromArgb(alpha, baseColor);

    internal static System.Drawing.Color FromArgb(int r, int g, int b) => System.Drawing.Color.FromArgb(r, g, b);

    internal static System.Drawing.Color FromArgb(
        int a,
        int r,
        int g,
        int b)
    ...
    internal static System.Drawing.Color GetBySide(Side side)
        => side switch
           {
               Side.Hikari   => Hikari,
               Side.Tairitsu => Tairitsu,
               Side.Achromic => Achromic,
               _             => White
           };
}
